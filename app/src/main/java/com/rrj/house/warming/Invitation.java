...
public class Invitation extends FragmentActivity{
...
//	ViewPager viewPager;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ImageView img = (ImageView)findViewById(R.id.invitationImage);
	...
	public void addToCalendar() {
		// TODO Auto-generated method stub
			...
			try {
				...
				String strEndDate = "02/06/2014 12.30";
				...
				myCal.AddEvent(startMilis, endMilis, "SuryaLeela", "Anand and Ramya's House ");
